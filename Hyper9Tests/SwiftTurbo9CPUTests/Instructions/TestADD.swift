...
struct TestADDB {
    ...
    @Test func test_addb_direct_all_flags() async throws {
        ...
        let accumulator : UInt8 = 0x02
        let cpu = Turbo9CPU.create(ram: [0x02, 0x00, storedByte], accb: accumulator)
...
struct TestADDD {
    @Test func test_addd_immediate() async throws {
        ...
        let cpu = Turbo9CPU.create(ram: [storedWord.highByte, storedWord.lowByte], acca: accumulator.highByte, accb: accumulator.lowByte)
        cpu.setupAddressing(using: .imm8)
    ...
    @Test func test_addd_direct_all_flags() async throws {
        ...
        let cpu = Turbo9CPU.create(ram: [0x02, 0x00, storedWord.highByte, storedWord.lowByte], acca: accumulator.highByte, accb: accumulator.lowByte)
